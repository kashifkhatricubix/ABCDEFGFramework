...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ABCDEFGFramework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kashif.khatri@cubixlabs.com/ABCDEFGFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kashif.khatri@cubixlabs.com' => 'kashif.khatri@cubixlabs.com' }
  s.source           = { :git => 'https://github.com/kashif.khatri@cubixlabs.com/ABCDEFGFramework.git', :tag => s.version.to_s }
